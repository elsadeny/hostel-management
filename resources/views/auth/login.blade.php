            ...
            <div class="mt-4">
                ...
                <div class="relative mt-1">
                    ...
                    <button type="button" id="toggle-password"
                        onclick="(function(){var i=document.getElementById('password'),b=document.getElementById('toggle-password'),e=b.querySelector('.eye-open'),h=b.querySelector('.eye-closed');if(i.type==='password'){i.type='text';e.classList.add('hidden');h.classList.remove('hidden');}else{i.type='password';e.classList.remove('hidden');h.classList.add('hidden');}})()"

...
use App\Http\Controllers\Student\RoomApplicationController;
...
Route::middleware(['auth'])->prefix('student')->name('student.')->group(function () {
    ...
    Route::get('/room-application', [RoomApplicationController::class, 'index'])->name('room-application');
    Route::post('/room-application', [RoomApplicationController::class, 'store'])->name('room-application.store');
    Route::patch('/room-application/{application}/cancel', [RoomApplicationController::class, 'cancel'])->name('room-application.cancel');
});
